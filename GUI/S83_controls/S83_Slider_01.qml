...
T.Slider {
    ...
    property int    h_slider: 48
    handle: S83_SliderHandle_01
        {
    ...
    background: Rectangle {
        ...
        implicitWidth: control.horizontal ? 200 : control.h_slider
        implicitHeight: control.horizontal ? control.h_slider : 200
        width: control.horizontal ? control.availableWidth : 4
        height: control.horizontal ? 4 : control.availableHeight
        scale: control.horizontal && control.mirrored ? -1 : 1
        color: control.enabled ? Color.transparent(color_slider, 0.22) : "#494949" //Color.transparent(color_slider, 0.11)
        radius: 2
        Rectangle
            {
            ...
            height: control.horizontal ? (parent.height + 1) : control.position * parent.height

            radius: 2
            //border.color: Color.transparent(color_slider, 0.50)
            //color: control.enabled ? control.Material.accentColor : control.Material.sliderDisabledColor
            color: control.enabled ? color_slider : "dimgray" //Color.transparent(color_slider, 0.22)
            }
        }
}
